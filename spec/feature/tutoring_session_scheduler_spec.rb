...
RSpec.describe TutoringSessionController, type: :feature do
  ...
  before { 
    ...
    User.create(first_name: 'Admin', last_name: 'User', encrypted_password: 'test', email: 'admin@tamu.com') 
  }
  
  after { Timecop.return }

  let(:tutor) { User.new(first_name: 'Tutor', last_name: 'User', encrypted_password: 'test', email: 'tutor@tamu.com') }
