...
class UsersController < ApplicationController
  ...
  def update
    @user = User.find(params[:id])
    params[:first_name] = @user.first_name if !params[:first_name] == nil
    params[:last_name] = @user.last_name if !params[:last_name] == nil
    params[:major] = @user.major if !params[:major] == nil
    params[:email] = @user.email if !params[:email] == nil
    params[:encrypted_password] = @user.encrypted_password if !params[:encrypted_password] == nil
