...
class UsersController < ApplicationController
  ...
  def update
    @user = User.find(params[:id])
    params[:first_name] = @user.first_name if !params[:first_name].exists?
    params[:last_name] = @user.last_name if !params[:last_name].exists?
    params[:major] = @user.major if !params[:major].exists?
    params[:email] = @user.email if !params[:email].exists?
    params[:encrypted_password] = @user.encrypted_password if !params[:encrypted_password].exists?
