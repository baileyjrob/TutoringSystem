...
.where("tutoring_sessions.session_status = 'Confirmed' OR tutoring_sessions.session_status = 'In-Person'")
.select('users.first_name,users.last_name,tutoring_sessions.scheduled_datetime,tutoring_sessions.complete_datetime')
