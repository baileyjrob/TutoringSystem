...
=begin User.create!(id: 0, first_name: 'Admin', last_name: 'User', email: 'admin@tamu.edu', password: 'T3st!!a')
...
TutoringSession.create(id: 1, tutor_id: user2.id, scheduled_datetime: Time.now, completed_datetime: 0,
                       session_status: '')
TutoringSession.create(id: 2, tutor_id: user3.id, scheduled_datetime: Time.now, completed_datetime: 0,
                       session_status: '') =end
