  ...
  describe 'POST delete_schedule' do
    context 'when user is signed in' do
      ...
      before do
        @tutor = tutor.save
        @user = user.save
        @tutoring_session1 = tutoring_session1.save
        @tutoring_session2 = tutoring_session2.save
        @tutoring_session3 = tutoring_session3.save
        @user.tutoring_sessions << [@tutoring_session1, @tutoring_session2, @tutoring_session3]
        sign_in user
      end
      it 'deletes' do
        expect(TutoringSession.find(@tutoring_session2.id)).to eq(@tutoring_session2)
