...
RSpec.describe UsersController, type: :feature do
  ...
  let!(:tutoring_session2) do
    TutoringSession.create(scheduled_datetime: '27 May 2021 08:00:00 +0000'.to_datetime, tutor_id: user.id)
  end
  let!(:tutoring_session3) do
    TutoringSession.create(scheduled_datetime: '28 May 2021 08:00:00 +0000'.to_datetime, tutor_id: user.id)
  end
