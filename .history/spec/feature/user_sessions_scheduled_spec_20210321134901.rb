...
RSpec.describe UsersController, type: :feature do
  ...
  it 'properly deletes sessions', js: true do
    td = page.find(:xpath, "//tr/td[contains(text(), 'May 26')]") # find the id td with text of exactly 22
    tr = td.find(:xpath, "//tr/td[contains(text(), 'May 26')]/parent::tr") # get the parent tr of the td
    within(tr) do
      accept_confirm do
