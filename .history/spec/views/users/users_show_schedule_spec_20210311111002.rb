...
RSpec.describe 'users/show_schedule.html.erb', type: :view do
  ...
  before do
    ...
    assigns(@sessions, [
      stub_model(TutoringSession, :tutor_id => 1, :scheduled_datetime => '25 May 02:00:00 +0000'.to_datetime),
      stub_model(TutoringSession, :tutor_id => 1, :scheduled_datetime => '26 May 02:00:00 +0000'.to_datetime),
      stub_model(TutoringSession, :tutor_id => 1, :scheduled_datetime => '27 May 02:00:00 +0000'.to_datetime)
    ])
