class MatchingController < ApplicationController
  ...
  def create
    ...
    User.create(user_id: 11, first_name: 'Adam', last_name: 'Apple',
                courses: 'MATH', email: 'adam@apple.com')
    User.create(user_id: 22, first_name: 'Barnie', last_name: 'Banana',
                courses: 'CHEM', email: 'barner@banana.com')
    User.create(user_id: 33, first_name: 'Carol', last_name: 'Cranberry',
                courses: 'MATH', email: 'carol@cranberry.com')
