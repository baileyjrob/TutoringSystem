...
user1 = User.create!(first_name: 'John', last_name: 'Doe', email: 'john@tamu.edu', password: 'T3st!!b')
...
TutoringSession.create(id: 1, tutor_id: user2.id, scheduled_datetime: Time.now + 100_005, completed_datetime: 0,
                       session_status: '')
TutoringSession.create(id: 2, tutor_id: user3.id, scheduled_datetime: Time.now + 100_000, completed_datetime: 0,
                       session_status: '')
TutoringSession.create(id: 3, tutor_id: user3.id, scheduled_datetime: Time.now, completed_datetime: 0,
                       session_status: '')
